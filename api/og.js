...
export default async function handler() {
  ...
  return new ImageResponse(
    <div style={{ width: '1200px', height: '630px', background: '#080608', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', fontFamily: 'serif', position: 'relative' }}>
      ...
      <div style={{ color: '#c9a84c', fontSize: '28px', letterSpacing: '0.4em', textTransform: 'uppercase', marginBottom: '16px', display: 'flex' }}>The Amazing Digital Circus</div>
      <div style={{ color: '#ffffff', fontSize: '64px', fontWeight: 'bold', marginBottom: '8px', display: 'flex' }}>⚔️ THE GREAT WAR</div>
      ...
      <div style={{ position: 'absolute', bottom: '40px', color: 'rgba(201,168,76,0.4)', fontSize: '14px', letterSpacing: '0.3em', display: 'flex' }}>PUBLIC SCORES ONLY · HIDDEN VARIABLES REVEALED AT THE FINALE</div>
    </div>,
