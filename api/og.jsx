...
export default async function handler() {
  ...
  return new ImageResponse(
    <div style={{ width: '1200px', height: '630px', background: '#080608', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', fontFamily: 'serif', position: 'relative' }}>
      <div style={{ color: '#c9a84c', fontSize: '28px', letterSpacing: '0.4em', marginBottom: '16px', display: 'flex' }}>THE AMAZING DIGITAL CIRCUS</div>
      <div style={{ color: '#ffffff', fontSize: '64px', fontWeight: 'bold', marginBottom: '48px', display: 'flex' }}>⚔️ THE GREAT WAR</div>
      <div style={{ display: 'flex', gap: '80px', alignItems: 'center' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px' }}>
          <div style={{ fontSize: '48px', display: 'flex' }}>🐀</div>
          <div style={{ color: '#a0522d', fontSize: '24px', display: 'flex' }}>RAT ARMY</div>
          <div style={{ color: '#a0522d', fontSize: '96px', fontWeight: 'bold', lineHeight: 1, display: 'flex' }}>{totals.rat}</div>
        </div>
        <div style={{ color: '#444', fontSize: '48px', display: 'flex' }}>VS</div>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px' }}>
          <div style={{ fontSize: '48px', display: 'flex' }}>🐱</div>
          <div style={{ color: '#9b59b6', fontSize: '24px', display: 'flex' }}>CAT ARMY</div>
          <div style={{ color: '#9b59b6', fontSize: '96px', fontWeight: 'bold', lineHeight: 1, display: 'flex' }}>{totals.cat}</div>
        </div>
      </div>
      <div style={{ position: 'absolute', bottom: '40px', color: 'rgba(201,168,76,0.4)', fontSize: '14px', display: 'flex' }}>PUBLIC SCORES ONLY · HIDDEN VARIABLES REVEALED AT THE FINALE</div>
    </div>,
